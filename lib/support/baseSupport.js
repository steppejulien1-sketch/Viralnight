...
// Le cadeau du jour est coupe depuis le 23/09/2026 (voir CADEAU_DU_JOUR
// dans app-preview.html). Ceux qui l'avaient connu demandent ou il est
// passe : on le dit, et on renvoie vers ce qui rapporte encore.
function cadeauDuJour(c) {
  return r(`Le cadeau du jour a été retiré de l'appli pour le moment. Pour gagner des points : une story qui mentionne l'établissement (100 points), le QR code sur place (15 points), ou un ami qui s'inscrit avec ton lien (100 points). ${solde(c)}`);
}
...
export const ENTREES = [
  ...
  ], repondre: () => r("Une story qui mentionne l'établissement : 100 points. Le QR code sur place : 15 points. Un ami qui s'inscrit avec ton lien : 100 points. Tout est détaillé dans Profil, Gagner des points.") },
  ...
  ], repondre: (c) => r(`${solde(c)}${prochaineRecompense(c) || " Chaque récompense affiche son prix dans Récompenses."} Pour aller plus vite : une story rapporte 100 points et le QR 15.`) },
