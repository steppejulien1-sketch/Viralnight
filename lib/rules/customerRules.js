...
export const customerRules = [
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: `Un client a genere a lui seul ${mostViralCustomerReach} vues cette soiree : envisager un statut ambassadeur.`,
        estimatedGain: 5,
        priority: "low",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: `${ctx.customerAnalytics.loyalCustomersCount} clients fideles (3+ soirees recentes) ont participe : un programme VIP dedie augmenterait leur retention.`,
        estimatedGain: 6,
        priority: "medium",
      };
    },
  ...
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: "Le taux de conversion scan -> publication est excellent cette soiree.",
        estimatedGain: 0,
        priority: "low",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: "Aucun client recurrent detecte sur les dernieres soirees : un programme de fidelisation pourrait combler ce manque.",
        estimatedGain: 4,
        priority: "low",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: "Moins de 30% des participants ont scanne le QR code : renforcer la visibilite du dispositif.",
        estimatedGain: 12,
        priority: "high",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: "Un seul client concentre plus de la moitie du reach total : la viralite repose sur trop peu de personnes.",
        estimatedGain: 0,
        priority: "medium",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "customer",
        message: `${ctx.customerAnalytics.uniquePublishers} clients differents ont publie cette soiree : bonne diversification de la source de viralite.`,
        estimatedGain: 0,
        priority: "low",
      };
    },
