...
export const timingRules = [
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: `Lancer le bonus x2 vers ${formatHour(hour)} maximiserait la réactivité avant le pic de scans.`,
        estimatedGain: 18,
        priority: "high",
      };
    },
  ...
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: `Le pic de scans QR se situe vers ${formatHour(hour)} : idéal pour distribuer les récompenses.`,
        estimatedGain: 12,
        priority: "medium",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: "Peu de publications en début de soirée (22h-23h) : un bonus d'entrée pourrait relancer l'activité tôt.",
        estimatedGain: 9,
        priority: "medium",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: "Une part importante des publications arrive en fin de soirée : envisager une seconde vague de récompenses après 1h.",
        estimatedGain: 11,
        priority: "medium",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: `Les pics de scan (${formatHour(scanPeakHour)}) et de publication (${formatHour(publicationPeakHour)}) sont décalés : synchroniser les incitations sur ces deux moments.`,
        estimatedGain: 7,
        priority: "low",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: "Aucun scan QR enregistré sur cette soirée : vérifier l'affichage et l'accessibilité du QR code.",
        estimatedGain: 0,
        priority: "high",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: `Les réclamations de récompenses culminent vers ${formatHour(top.hour)}.`,
        estimatedGain: 5,
        priority: "low",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: "L'activité de publication est répartie de manière très homogène sur la soirée, sans créneau dominant.",
        estimatedGain: 0,
        priority: "low",
      };
    },
  },
  {
    ...
    evaluate(ctx) {
      ...
      return {
        id: this.id,
        category: "timing",
        message: "Minuit concentre la plus grande part des publications : c'est le créneau prioritaire pour toute activation.",
        estimatedGain: 14,
        priority: "high",
      };
    },
