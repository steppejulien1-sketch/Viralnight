...
CLUB_APPLI = [
    (CLUB, "07-tableau-de-bord", "Onglet 1", "Tableau de bord",
     "La période commande tout l’écran, et chaque chiffre porte sa variation sur la période d’avant. Avant : l’entête annonçait 14 jours, le graphe montrait 14 jours, et les quatre chiffres étaient des totaux depuis le début.", ""),
    (CLUB, "07b-tableau-de-bord-7j", "Onglet 1", "Le même, sur 7 jours",
     "Le trait pointillé est la semaine précédente, nommée dans la légende avec son total. Référence : Google Analytics et Stripe, qui tracent tous deux la période comparée sous la courante.", ""),
    ...
    (CLUB, "14-conditions", "Réglages", "Conditions d’utilisation",
     "Écrites pour CETTE appli, et lues DEDANS. Les liens ouvraient les pages du site, qui parlent de formulaires de démo et de cookies de navigation.", "à faire relire"),
    (CLUB, "15-confidentialite", "Réglages", "Confidentialité",
     "Ce qu’on garde, pourquoi, et ce qu’on ne fait pas. Le gérant voit des totaux, jamais qui a publié quoi.", "à faire relire"),
]

CLUBBEUR_APPLI = [
    (CLUBBEUR, "01-accueil", "Arriv\u00e9e", "L\u2019accueil",
     "Ce que voit quelqu\u2019un qui vient de scanner le QR coll\u00e9 au mur du club.", ""),
    (CLUBBEUR, "02-recompenses", "Onglet 1", "R\u00e9compenses, fa\u00e7on DUSK",
     "Comme l\u2019onglet Rewards de DUSK : l\u2019encadr\u00e9 de points, la grande carte qui dit comment on gagne (chez eux \u00ab Add a card \u00bb, chez nous la story), la ligne de parrainage.", "nouveau"),
    (CLUBBEUR, "03-recompenses-cartes", "Onglet 1", "Le catalogue du club",
     "La section titr\u00e9e (\u00ab NEW DROP \u00bb chez DUSK, \u00ab AU MIRANO \u00bb ici) et les r\u00e9compenses en rang\u00e9e qui glisse. Image carr\u00e9e, points dessus, tuile du club \u00e0 cheval.", "nouveau"),
